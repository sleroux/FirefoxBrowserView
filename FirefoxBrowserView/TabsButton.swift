...
class TabsButton: UIView {
    let count: Int = 3
    private let countFont = UIFont.boldSystemFont(ofSize: 10)
    ...
    override func draw(_ rect: CGRect) {
        ...
        var textRect = nsCountText.boundingRect(with: frontFrame.size, options: .usesLineFragmentOrigin, attributes: textAttributes, context: nil)
        ...
        nsCountText.draw(in: textRect, withAttributes: textAttributes)
    }
}
